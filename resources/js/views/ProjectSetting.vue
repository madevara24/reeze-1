    ...
    <v-container fluid style="width:75%">
        ...
        <v-row>
            ...
            <v-snackbar v-model="snackbar.isUp" :timeout="2000">
                {{ snackbar.message }}
                <v-btn color="blue" text @click="snackbar.isUp = false"
                    >Close</v-btn
                >
            </v-snackbar>
            <v-spacer></v-spacer>
            <v-col cols="5" class="ml-5">
                ...
                >
                    <template v-slot:no-data>
                        <v-list-item>
                            <v-list-item-title
                                >Search for project member</v-list-item-title
                            >
                        </v-list-item>
                    </template>
...
export default {
    ...
    methods: {
                ...
                this.axios
                    ...
                    .then(response => {
                        this.snackbar.message =
                            "Project setting has been updated";
        ...
        deleteProject() {
            ...
            this.axios
                .delete(
                `${this.appUrl}/api/v1/project/${selectedProjectId}/delete`,
                    {
                        headers
                    }
                )
                .then(response => {
                    this.snackbar.message = `Project has been deleted.`;
                    this.snackbar.isUp = true;
